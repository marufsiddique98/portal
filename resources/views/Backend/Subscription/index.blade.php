                            ...
                            <div class="form-group mb-4 w-50 ml-4 mt-2">
                                ...
                                <div class="n-chk">
                                    <label class="new-control new-radio radio-primary" style="font-size: medium">
                                        <input type="radio" class="new-control-input" name="plan" value="price_1Lnkk9C7DhbbV76TdV6cS5eS" checked>
                                        <span class="new-control-indicator"></span>SERU Mock Tests Premium Plan for £10
                                    </label>
                                </div>
                            </div>
